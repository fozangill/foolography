...
class Shortener
{
    ...
    protected function urlExistsInDB($url){
        ...
        $query = "SELECT short_code FROM ".self::$table." WHERE user_id = :user_id AND long_url = :long_url LIMIT 1";
    ...
    $email = $_SESSION['email'];
       $user_id = $_SESSION['user_id'];
        ...
        $query = "INSERT INTO ".self::$table." (user_id, long_url, short_code, created) VALUES (:user_id, :long_url, :short_code, :timestamp)";
